	...
	<Item Name="Messages of This Actor" Type="Folder">
		<Item Name="Outbound" Type="Folder">
			<Item Name="Data" Type="Folder">
				<Item Name="Project Number Msg.lvclass" Type="LVClass" URL="../../Main View Messages/Project Number Msg/Project Number Msg.lvclass"/>
				<Item Name="Sensor Number Msg.lvclass" Type="LVClass" URL="../../Main View Messages/Sensor Number Msg/Sensor Number Msg.lvclass"/>
			</Item>
		</Item>
	</Item>
	<Item Name="Main View.lvclass" Type="LVClass" URL="../Main View.lvclass"/>
</Library>
