	...
	<Item Name="Messages of This Actor" Type="Folder">
		<Item Name="Outbound" Type="Folder">
			<Item Name="Data" Type="Folder">
				<Item Name="Conceret Initialize Msg.lvclass" Type="LVClass" URL="../../Create Project View Messages/Conceret Initialize Msg/Conceret Initialize Msg.lvclass"/>
				<Item Name="Conceret Key Focus Msg.lvclass" Type="LVClass" URL="../../Create Project View Messages/Conceret Key Focus Msg/Conceret Key Focus Msg.lvclass"/>
			</Item>
		</Item>
	</Item>
	<Item Name="Create Project View.lvclass" Type="LVClass" URL="../Create Project View.lvclass"/>
</Library>
